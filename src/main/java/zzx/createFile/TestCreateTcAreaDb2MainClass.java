 ...
 * */
public class TestCreateTcAreaDb2MainClass {
	...
	public void generator() throws Exception{
		...
		File configFile = new File("db/create_tc_area_db2.xml"); 
		//创建配置解析器
	...
	public static void main(String[] args) throws Exception {
		try {
			TestCreateTcAreaDb2MainClass generatorSqlmap = new TestCreateTcAreaDb2MainClass();
